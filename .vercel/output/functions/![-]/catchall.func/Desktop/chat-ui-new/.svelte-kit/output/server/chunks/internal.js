import { H as HYDRATION_ERROR, C as COMMENT_NODE, a as HYDRATION_END, g as get_next_sibling, b as HYDRATION_START, c as HYDRATION_START_ELSE, e as effect_tracking, d as get, s as source, r as render_effect, u as untrack, i as increment, q as queue_micro_task, f as active_effect, h as block, j as branch, B as Batch, p as pause_effect, k as create_text, l as set_active_effect, m as set_active_reaction, n as set_component_context, o as handle_error, t as active_reaction, v as component_context, w as move_effect, x as internal_set, y as destroy_effect, z as invoke_error_boundary, A as svelte_boundary_reset_onerror, E as EFFECT_TRANSPARENT, D as EFFECT_PRESERVED, F as BOUNDARY_EFFECT, G as init_operations, I as get_first_child, J as hydration_failed, K as clear_text_content, L as array_from, M as component_root, N as push, O as pop, P as set, Q as LEGACY_PROPS, R as flushSync, S as define_property, T as mutable_source } from "./utils2.js";
...
<html lang="en" class="h-full">\r
	<head>\r
		...
		<link rel="icon" href="/chatui-new/logo.svg" type="image/svg+xml" />\r
		<link\r
			rel="icon"\r
			href="/chatui-new/light/logo.svg"\r
			type="image/svg+xml"\r
			media="(prefers-color-scheme: light)"\r
		/>\r
		<link\r
			rel="icon"\r
			href="/chatui-new/logo.svg"\r
			type="image/svg+xml"\r
			media="(prefers-color-scheme: dark)"\r
		/>\r
		<link rel="apple-touch-icon" href="/chatui-new/apple-touch-icon-180x180.png" />\r
		<link rel="manifest" href="/chatui-new/site.webmanifest" />\r
		<script>\r
			(function () {\r
				try {\r
					var html = document.documentElement;\r
					html.classList.remove("dark", "stone", "red", "indigo");\r
					var stored = localStorage.getItem("theme");\r
					var prefersDark = window.matchMedia("(prefers-color-scheme: dark)").matches;\r
					var useSystem = stored === null || stored === "system";\r
					var meta = document.querySelector('meta[name="theme-color"]');\r
\r
					function applyDark(color) {\r
						html.classList.add("dark");\r
						if (meta) meta.setAttribute("content", color);\r
					}\r
\r
					if (stored === "stone") {\r
						applyDark("#050505");\r
						html.classList.add("stone");\r
					} else if (stored === "red") {\r
						applyDark("#1a0505");\r
						html.classList.add("red");\r
					} else if (stored === "indigo") {\r
						applyDark("#0c0a1d");\r
						html.classList.add("indigo");\r
					} else if (stored === "dark" || (useSystem && prefersDark)) {\r
						applyDark("#07090d");\r
					} else if (meta) {\r
						meta.setAttribute("content", "rgb(249, 250, 251)");\r
					}\r
				} catch (e) {}\r
			})();\r
\r
			...
			window.gaId = "%gaId%";\r
		<\/script>\r
		` + head + '\r\n	</head>\r\n	<body data-sveltekit-preload-data="hover" class="h-full bg-[#f3f4f6] dark:bg-gray-900">\r\n		<div id="app" class="contents h-full">' + body + `</div>\r
\r
