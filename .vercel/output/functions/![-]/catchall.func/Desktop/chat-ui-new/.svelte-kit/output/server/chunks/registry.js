...
import { g as getLocalMcpClient } from "./localRegistry.js";
...
async function listLocalServerTools(name, opts = {}) {
...
async function getOpenAiToolsForMcp(servers, localServerNames = [], { ttlMs = DEFAULT_TTL_MS, signal } = {}) {
  const now = Date.now();
