...
import { O as OIDConfig, s as sha256, g as getCoupledCookieHash, c as tokenSetToSessionOauth, r as refreshSessionCookie, v as validateAndParseCsrfToken, d as getOIDCUserData } from "../../../../chunks/auth.js";
import { z } from "zod";
...
async function updateUser(params) {
  ...
  if (existingUser) {
    ...
    const { insertedId } = await collections.users.insertOne({
      ...
      isEarlyAccess,
      lastLoginAt: /* @__PURE__ */ new Date()
      // ✅ Track Login Time for New Users
    });
    userId = insertedId;
    await collections.sessions.insertOne({
      _id: new ObjectId(),
